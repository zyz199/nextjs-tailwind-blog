...
slug: 001-js-change-object-learn
...
JS 选择器常用的有`getElementById()`、`getElementsByClassName()`、`getElementsByName()`、`getElementsByTagName()`、`querySelector()`、`querySelectorAll()`。
...
<script type="text/javascript">
  ...
  Array.prototype.forEach.call(t4List, function (v) {
    console.log(v)
  })
  Array.prototype.map.call(t4List, function (v) {
    console.log(v)
  })
</script>
```
...
<script type="text/javascript">
  ...
  t6List.forEach(function (v) {
    console.log(v)
  })
  Array.prototype.map.call(t6List, function (v) {
    console.log(v)
  })
</script>
```
